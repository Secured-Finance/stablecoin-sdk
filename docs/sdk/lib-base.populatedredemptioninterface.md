...
[Home](./index.md) &gt; [@secured-finance/lib-base](./lib-base.md) &gt; [PopulatedRedemptionInterface](./lib-base.populatedredemptioninterface.md)
...
```
**Extends:** [PopulatedTransactionInterface](./lib-base.populatedtransactioninterface.md)<!-- -->&lt;P, [SentProtocolTransaction](./lib-base.sentprotocoltransaction.md)<!-- -->&lt;S, [ProtocolReceipt](./lib-base.protocolreceipt.md)<!-- -->&lt;R, [RedemptionDetails](./lib-base.redemptiondetails.md)<!-- -->&gt;&gt;&gt;
...
[attemptedDebtTokenAmount](./lib-base.populatedredemptioninterface.attempteddebttokenamount.md)
...
[isTruncated](./lib-base.populatedredemptioninterface.istruncated.md)
...
[redeemableDebtTokenAmount](./lib-base.populatedredemptioninterface.redeemabledebttokenamount.md)
...
[increaseAmountByMinimumNetDebt(maxRedemptionRate)](./lib-base.populatedredemptioninterface.increaseamountbyminimumnetdebt.md)

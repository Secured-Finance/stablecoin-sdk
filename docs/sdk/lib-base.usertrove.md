...
[Home](./index.md) &gt; [@secured-finance/lib-base](./lib-base.md) &gt; [UserTrove](./lib-base.usertrove.md)
...
The SDK uses the base [Trove](./lib-base.trove.md) class as a generic container of collateral and debt, for example to represent the [total collateral and debt](./lib-base.readableprotocol.gettotal.md) locked up in the protocol.

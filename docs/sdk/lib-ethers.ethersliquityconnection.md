...
|  [liquidityMiningLQTYRewardRate](./lib-ethers.ethersliquityconnection.liquiditymininglqtyrewardrate.md) | Decimal | Amount of LQTY collectively rewarded to stakers of the liquidity mining pool per second. |
...
|  [totalStabilityPoolLQTYReward](./lib-ethers.ethersliquityconnection.totalstabilitypoollqtyreward.md) | Decimal | Total amount of LQTY allocated for rewarding stability depositors. |

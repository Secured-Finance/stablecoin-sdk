...
[Home](./index.md) &gt; [@secured-finance/lib-ethers](./lib-ethers.md) &gt; [PopulatedEthersTransaction](./lib-ethers.populatedetherstransaction.md)
...
```
**Implements:** [PopulatedTransactionInterface](./lib-base.populatedtransactioninterface.md)<!-- -->&lt;[EthersPopulatedTransaction](./lib-ethers.etherspopulatedtransaction.md)<!-- -->, [SentEthersTransaction](./lib-ethers.sentetherstransaction.md)<!-- -->&lt;T&gt;&gt;

## Remarks

Returned by [PopulatableEthers](./lib-ethers.populatableethers.md) functions.
...
[gasHeadroom?](./lib-ethers.populatedetherstransaction.gasheadroom.md)
...
[rawPopulatedTransaction](./lib-ethers.populatedetherstransaction.rawpopulatedtransaction.md)

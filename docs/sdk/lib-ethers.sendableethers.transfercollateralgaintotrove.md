...
[Home](./index.md) &gt; [@secured-finance/lib-ethers](./lib-ethers.md) &gt; [SendableEthers](./lib-ethers.sendableethers.md) &gt; [transferCollateralGainToTrove](./lib-ethers.sendableethers.transfercollateralgaintotrove.md)
...
Promise&lt;[SentEthersTransaction](./lib-ethers.sentetherstransaction.md)<!-- -->&lt;[CollateralGainTransferDetails](./lib-base.collateralgaintransferdetails.md)<!-- -->&gt;&gt;

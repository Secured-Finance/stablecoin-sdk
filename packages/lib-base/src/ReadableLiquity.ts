...
export interface ReadableLiquity {
   ...
   * {@link @secured-finance/lib-base#ReadableLiquity.getTrove | getTrove()}.
   */
   ...
   * {@link @secured-finance/lib-base#TransactableLiquity.claimCollateralSurplus | claimCollateralSurplus()}.
   */

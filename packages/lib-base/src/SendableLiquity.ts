 ...
 *
 * @remarks
 * Implemented by {@link @secured-finance/lib-ethers#SentEthersLiquityTransaction}.
 *
 * @public
 */
export interface SentLiquityTransaction<S = unknown, T extends LiquityReceipt = LiquityReceipt> {
   ...
   *
   * @remarks
   * Unlike {@link @secured-finance/lib-base#SentLiquityTransaction.waitForReceipt | waitForReceipt()},
 ...
 *
 * Implemented by {@link @secured-finance/lib-ethers#SendableEthersLiquity}.
 *
 * @public
 */

...
/**
 * Details of a {@link TransactableLiquity.redeemDebtToken | redeemDebtToken()} transaction.
 *
 * @public
 */
...
/**
 * Details of a
 * {@link TransactableLiquity.depositDebtTokenInStabilityPool | depositDebtTokenInStabilityPool()} or
 * {@link TransactableLiquity.withdrawDebtTokenFromStabilityPool | withdrawDebtTokenFromStabilityPool()}
 * transaction.
 *
 * @public
 */
 ...
 *
 * Implemented by {@link @secured-finance/lib-ethers#EthersLiquity}.
 *
 * @public
 */
export interface TransactableLiquity {
   ...
   *
   * @remarks
   * Use {@link @secured-finance/lib-base#ReadableLiquity.getCollateralSurplusBalance | getCollateralSurplusBalance()}
   ...
   * {@link @secured-finance/lib-base#TransactableLiquity.stakeUniTokens | stakeUniTokens()}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */

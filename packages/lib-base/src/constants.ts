 ...
 * @public
 */
export const LIQUIDATION_RESERVE = Decimal.from(process.env.SF_ENV === "development" ? 2 : 20);
 ...
 * @public
 */
export const MINIMUM_NET_DEBT = Decimal.from(process.env.SF_ENV === "development" ? 18 : 180);

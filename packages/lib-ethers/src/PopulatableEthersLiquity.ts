    ...
    SentLiquityTransaction<EthersTransactionResponse, LiquityReceipt<EthersTransactionReceipt, T>>
{
  ...
  /** {@inheritDoc @secured-finance/lib-base#SentLiquityTransaction.getReceipt} */
  ...
  /**
   * {@inheritDoc @secured-finance/lib-base#SentLiquityTransaction.waitForReceipt}
   *
   * @throws
    ...
    PopulatedLiquityTransaction<EthersPopulatedTransaction, SentEthersLiquityTransaction<T>>
{
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatedLiquityTransaction.send} */
...
/**
 * {@inheritDoc @secured-finance/lib-base#PopulatedRedemption}
 *
 * @public
 */
export class PopulatedEthersRedemption
  ...
  implements
    ...
    >
{
  /** {@inheritDoc @secured-finance/lib-base#PopulatedRedemption.attemptedDebtTokenAmount} */
  readonly attemptedDebtTokenAmount: Decimal;

  /** {@inheritDoc @secured-finance/lib-base#PopulatedRedemption.redeemableDebtTokenAmount} */
  readonly redeemableDebtTokenAmount: Decimal;

  /** {@inheritDoc @secured-finance/lib-base#PopulatedRedemption.isTruncated} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatedRedemption.increaseAmountByMinimumNetDebt} */
  increaseAmountByMinimumNetDebt(
    maxRedemptionRate?: Decimalish
  ): Promise<PopulatedEthersRedemption> {
...
/**
 * Ethers-based implementation of {@link @secured-finance/lib-base#PopulatableLiquity}.
 *
 * @public
 */
    ...
    >
{
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.openTrove} */
  async openTrove(
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.closeTrove} */
  async closeTrove(
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersLiquityTransaction<TroveClosureDetails>> {
    overrides = this._prepareOverrides(overrides);
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.depositCollateral} */
  depositCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.withdrawCollateral} */
  withdrawCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.borrowDebtToken} */
  borrowDebtToken(
    amount: Decimalish,
    maxBorrowingRate?: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.repayDebtToken} */
  repayDebtToken(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<PopulatedEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.adjustTrove} */
  async adjustTrove(
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.claimCollateralSurplus} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.liquidate} */
  async liquidate(
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.liquidateUpTo} */
  async liquidateUpTo(
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.depositDebtTokenInStabilityPool} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.withdrawDebtTokenFromStabilityPool} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.withdrawGainsFromStabilityPool} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.transferCollateralGainToTrove} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.sendDebtToken} */
  async sendDebtToken(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.redeemDebtToken} */
  async redeemDebtToken(
    ...
    const [fees, total, [truncatedAmount, firstRedemptionHint, ...partialHints]] = await Promise.all(
      [
        ...
        this._readable.getTotal(),
        this._findRedemptionHints(attemptedDebtTokenAmount)
      ]
    );
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.withdrawGainsFromStaking} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.approveUniTokens} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.stakeUniTokens} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.unstakeUniTokens} */
  ...
  /** {@inheritDoc @secured-finance/lib-base#PopulatableLiquity.exitLiquidityMining} */

...
//
// Currently, `@secured-finance/stablecoin-lib-ethers` makes many of its read calls through Signers, which populates
// `from`. Instead these calls should be made through a Provider, and `from` should be omitted
// (since none of the read calls in this protocol care about `msg.sender`).
//
